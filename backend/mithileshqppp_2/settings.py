"""
Django settings for mithileshqppp_2 project.
...
ROOT_URLCONF = 'mithileshqppp_2.urls'
...
WSGI_APPLICATION = 'mithileshqppp_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithileshqppp_2 API",
    "DESCRIPTION": "API documentation for mithileshqppp_2 App",
    "VERSION": "v1",
}
